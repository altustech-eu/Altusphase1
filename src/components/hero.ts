...
@Component({
  ...
  template: `
    <section class="relative bg-white font-main overflow-hidden pt-8 lg:pt-12 pb-8 lg:pb-10 min-h-[560px] lg:min-h-[680px] flex items-center">
      
      <div class="absolute inset-0 pointer-events-none z-0 overflow-hidden opacity-40">
        <svg class="absolute top-0 left-[10%] w-[700px] text-slate-100" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <path fill="currentColor" d="M45.7,-76.3C58.9,-69.3,69.2,-55.3,77.5,-40.5C85.8,-25.7,92.1,-10.1,89.5,4.3C86.9,18.6,75.4,31.7,64.2,42.9C53,54.1,42.1,63.4,28.8,71.2C15.5,79, -0.2,85.3,-15.5,83.1C-30.8,80.9,-45.7,70.2,-57.4,57.4C-69.1,44.6,-77.6,29.7,-82.1,13.5C-86.6,-2.7,-87.1,-20.2,-79.8,-34C-72.5,-47.8,-57.4,-57.9,-42.8,-64.3C-28.2,-70.7,-14.1,-73.4,1.4,-75.2C16.9,-77,32.5,-83.3,45.7,-76.3Z" transform="translate(100 100) scale(1.1)" />
        </svg>
      </div>

      <div class="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
        
        <div class="col-span-1 lg:col-span-7 pt-4 lg:pt-0">
          ...
          <h1 class="text-4xl sm:text-5xl lg:text-[40px] font-bold text-[#1e293b] leading-[1.12] tracking-tight mb-5">
          ...
          <p class="text-slate-600 text-[15px] sm:text-base leading-relaxed mb-7 max-w-[600px] font-medium">
          ...
          <div class="max-w-[700px]">
            ...
            <div class="flex items-center gap-6 sm:gap-8 mb-4">
              <button 
                (click)="setTab('jobs')"
        ...
        <div class="col-span-1 lg:col-span-5 relative flex justify-center lg:justify-end self-center mt-4 lg:mt-0">
          <img 
            src="https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=800" 
            alt="Professionals in Healthcare, IT, and Education" 
            class="w-[88%] sm:w-[76%] lg:w-[100%] h-[280px] lg:h-[390px] object-cover rounded-3xl shadow-2xl z-10 border-4 border-white transform translate-x-[2%] lg:-translate-y-6"
          />
        </div>
...
export class HeroComponent {
  ...
  getPlaceholder1(): string {
    switch (this.activeTab) {
      case 'ausbildung':
        return 'Program, Profession or Keyword';
      case 'study':
        return 'University, Course or Field of Study';
      case 'jobs':
      default:
        return 'Job title, Keyword or Company';
    }
  }
}